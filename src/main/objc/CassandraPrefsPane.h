...
@interface CassandraPrefsPane : NSPreferencePane
...
//Button press to start or stop the Cassandra server and updates the relevant textfields and images.
...
//Starts or stops the Cassandra server and updates the relevant textfields and images.
